...
const Menu = ({ anecdotes, addNew, anecdoteById, notification, showMessage }) => {
  const padding = {
    paddingRight: 5
  }
  return (
    ...
    <Router>
      <div>
        <div>
          ...
          <Route path="/create" render={() => <CreateNew addNew={addNew} showMessage={showMessage} />} />
...
const App = () => {
  ...
  return (
    <div>
      ...
      <Menu anecdotes={anecdotes} addNew={addNew} anecdoteById={anecdoteById} showMessage={showMessage} notification={notification} />
      <Footer />
    </div>
  )
}
